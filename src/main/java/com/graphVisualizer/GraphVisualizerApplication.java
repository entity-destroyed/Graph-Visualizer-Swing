...
public class GraphVisualizerApplication {
    ...
    /**
     * The main method that serves as the entry point for the GraphVisualizerApplication.
     * It initializes and starts the application using Swing's event dispatch thread.
     *
